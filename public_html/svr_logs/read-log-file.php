...
// Set the username in the below variable to your BU username, the code will not work without it.
...
// tailCustom function                                     
$selectedLines = tailCustom("/home/".$username."/logs/".$username.".bucomputing.uk_error.log", $lines);
